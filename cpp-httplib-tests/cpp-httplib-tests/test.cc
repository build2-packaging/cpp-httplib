...
#define SERVER_CERT_FILE CERT_PATH "/cert.pem"
#define SERVER_CERT2_FILE CERT_PATH "/cert2.pem"
#define SERVER_PRIVATE_KEY_FILE CERT_PATH "/key.pem"
#define CA_CERT_FILE CERT_PATH "/ca-bundle.crt"
#define CLIENT_CA_CERT_FILE CERT_PATH "/rootCA.cert.pem"
#define CLIENT_CA_CERT_DIR CERT_PATH
#define CLIENT_CERT_FILE CERT_PATH "/client.cert.pem"
#define CLIENT_PRIVATE_KEY_FILE CERT_PATH "/client.key.pem"
#define SERVER_ENCRYPTED_CERT_FILE CERT_PATH "/cert_encrypted.pem"
#define SERVER_ENCRYPTED_PRIVATE_KEY_FILE CERT_PATH "/key_encrypted.pem"
...
TEST_F(ServerTest, SlowRequest) {
  ...
  request_threads_.push_back(
      std::thread([this]() { auto res = cli_.Get("/slow"); }));
  request_threads_.push_back(
      std::thread([this]() { auto res = cli_.Get("/slow"); }));
  request_threads_.push_back(
      std::thread([this]() { auto res = cli_.Get("/slow"); }));
